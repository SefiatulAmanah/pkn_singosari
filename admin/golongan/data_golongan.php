<div class="card card-info">
	<div class="card-header" style="background-color : #455A64;">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Riwayat Golongan
		</h3>
	</div>
	<br>
	<center>
					...
					while ($data = $sql->fetch_assoc()) {
						...
						<tr>
							...
							<td style="display:flex;flex-direction:column">
								<!-- button 1 -->
								<div>
									<a href="?page=view-golongan&kode=<?php echo $data['id_golongan']; ?>&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>"
										title="Detail" class="btn btn-info btn-sm">
										<i class="fa fa-eye"></i>
									</a>

									<a href="?page=edit-golongan&kode=<?php echo $data['id_golongan']; ?>&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>"
										title="Ubah" class="btn btn-success btn-sm">
										<i class="fa fa-edit"></i>
									</a>
									<?php if ($_SESSION["ses_level"] == 'Administrator') { ?>
										<a href="?page=del-golongan&kode=<?php echo $data['id_golongan']; ?>&nik=<?php echo $_GET['nik']; ?>&nama=<?php echo $_GET['nama']; ?>"
