...
if (isset ($_GET['kode'])) {
	$sql_cek = "SELECT * from data_pegawai WHERE nik='" . $_GET['kode'] . "'";
	...
	<div class="dropdown">
		...
		<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
			<a href="?page=data-golongan&nik=<?php echo $data_cek['nik']; ?>&nama=<?php echo $data_cek['nama_lengkap']; ?>"
				class="dropdown-item"> <span class="menu-collapsed">Riwayat Pegawai</span>
			</a>
			...
			<a href="?page=data-satya&nik=<?php echo $data_cek['nik']; ?>&nama=<?php echo $data_cek['nama_lengkap']; ?>"
				class="dropdown-item">
				<span class="menu-collapsed">Riwayat Satya Lencana</a>
		</div>
