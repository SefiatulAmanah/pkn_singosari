...
<body>
	<center>
		...
		<h2>
			...
			$sql_tampil = "select * from data_pegawai where nik='$nik'";
	...
	<table id="example" class="table table-striped table-bordered" style="width:100%">
		...
		<div class="row">
			...
			<tr>
				<td width="30%;">Nomor Karpeg</td>
				<td>:</td>
				<td>
					<?php echo $data['nomor_karpeg']; ?>
				</td>
			</tr>
			<tr>
				<td width="30%;">Nomor Npwp</td>
				<td>:</td>
				<td>
			...
			<tr>
				<td width="30%;">Nomor Kpe</td>
				<td>:</td>
				<td>
					<?php echo $data['nomor_kpe']; ?>
				</td>
			</tr>
			<?php } ?>
		</tbody>
