<div class="card card-info">
	...
	<div class="card-body">
			...
			// Kenaikan Pangkat 6 Bulan sebelum 4 tahun dari TMT_KP 
			  ...
			  //perlu di perhatikan
			  $sql = $koneksi->query("SELECT *,TIMESTAMPDIFF(MONTH,TIMESTAMPADD(YEAR,4,tmt_kp),CURDATE()) as hmin from riwayat_golongan a 
			  INNER JOIN data_pegawai b ON a.nik=b.nik 
			  WHERE TIMESTAMPDIFF(MONTH,CURDATE(),tmt_kp) <= 6 $usersql");
			...
			//Pensiun 8 Bulan Kurang 58 Tahun dari Tanggal Lahir 
			  $sql = $koneksi->query("SELECT TIMESTAMPDIFF(MONTH,tanggal_lahir,CURDATE())-8 as usia,696 - (TIMESTAMPDIFF(MONTH,tanggal_lahir,CURDATE())) as hmin, a.nama_lengkap from data_pegawai a
