            ...
            <div class="form-group row">
				...
				<div class="col-sm-5">
					<select name="satya_lencana" id="satya_lencana" class="form-control">
						<option>- Pilih -</option>
						<option value="satya lancana x">Satya Lancana X</option>
						<option value="satya lancana xx">Satya Lancana XX</option>
                        <option value="satya lancana xxx">Satya Lancana XXX</option>
					</select>
				</div>
			</div>
