...
--
-- Host: localhost:3306
-- Generation Time: Mar 21, 2024 at 12:31 PM
...
(202020, 7, 'anandah', '', 'sda', '2024-03-20', 'Perempuan', 'Katolik', '', 'dnnw', 99, 90403099, 'Belum Menikah', 'Aktif', 'PNS Kab/Kota Bekerja Pada Kab/Kota', 'nvnv', 'nrjn', 'jfdnjkdn', 'nbsfdb', 'nvn', 'III a'),
(310103, 310103, 'yoga', 'dsfjsnsdn', 'f', '2024-03-27', 'Laki-laki', 'Kristen', '534343', 'fdvdcxv', 49, 432, 'Menikah', 'Aktif', 'PNS Kab/Kota DPK Pada Instansi Negeri', 'gdfd', 'df', 'df', 'dfg', 'd', 'II a');
...
(8, 202020, 'anandah', 'Diklat Struktural', 'gfghn', 7, '2024-03-21', 'ghhb ', 'hjnjk', 'image_2024-03-14_132502126.png');
...
(28, 202020, 'anandah', 'Badan Narkotika Nasional', 'Badan Narkotika Nasional', 'nnsnv', 'Jabatan Fungsional Tertentu', 'ncsmn', '2024-03-21', 'nxmcnm', '2024-03-30', '');
...
(9, 202020, 'anandah', 'II/a', '2024-03-01', 2, 3, 87879, '2024-03-01', 'kgb', 54343000, 'tgrdg', '');
...
(1, 202020, 'anandah', 'diklat fungsional', 'hbh', 2, '2024-03-29', '2024-03-29', 'fdf', 'dfd', '');
...
(14, 202020, 'anandah', '2024-03-13', 34431111, '2024-03-25', 4, '2024-03-21', 5, '2024-03-04', 7, '2024-03-21', 8, '2024-03-27', 'Umum', ''),
(15, 202020, 'anandah', '2024-02-27', 9899, '2024-03-01', 879879, '2024-02-29', 6, '2024-03-28', 980787, '2024-03-21', 878798, '2024-02-29', 'Umum', ''),
(16, 202020, 'anandah', '2024-03-31', 9899, '2024-03-08', 99, '2024-04-01', 98978, '2024-03-02', 77, '2024-03-23', 878798, '2024-04-05', 'Tenaga Honorer', 'ag.png');
...
(1, 202020, 'anandah', 'gdkkkk', '2024-03-07', '2024-03-14', 'fgd', '2024-03-07', 'dg', 'dgf', 4, 3, 3, '');
...
(5, 202020, 'anandah', 'D2', 'bfb', '94389', '2024-03-17', 'nf', 'hfrj', 'Tidak', '');
...
(1, 202020, 'anandah', 'fdgf', '2024-03-14', '2024-02-28', 'cds', '');
...
(5, 202020, 'anandah', 444, 'ndsnjngjfnk', '34332', 'bfvgc', 'fgbcv', 'fgbhf', 3, 3, 'd', ''),
(6, 202020, 'anandah', 4, 'h', '2', 'h', 'h', 'h', 9, 9, 'n', ''),
(7, 202020, 'anandah', 5, 'jakakakaaaa', 'm', 'k', 'k', 'k', 9, 9, 'n', '');
...
(2, 202020, 'anandah', 'jnm', '2024-03-11', '2024-03-11', 67, 'satya lencana xx', '');
...
--
ALTER TABLE `riwayat_diklat`
  MODIFY `id_diklat` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `riwayat_hukuman_disiplin`
  MODIFY `id_hukuman` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `riwayat_jabatan`
--
ALTER TABLE `riwayat_jabatan`
  MODIFY `id_jabatan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `riwayat_kenaikan_gaji_berkala`
  MODIFY `id_gaji` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `riwayat_mutasi_cpns_ke_pns`
  MODIFY `id_mutasi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `riwayat_pangkat`
--
ALTER TABLE `riwayat_pangkat`
  MODIFY `id_pangkat` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `riwayat_pendidikan`
--
ALTER TABLE `riwayat_pendidikan`
  MODIFY `id_pendidikan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `riwayat_penghargaan`
--
ALTER TABLE `riwayat_penghargaan`
  MODIFY `id_penghargaan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `riwayat_penilaian_kinerja`
--
ALTER TABLE `riwayat_penilaian_kinerja`
  MODIFY `id_penilaian` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `riwayat_satya_lencana`
--
ALTER TABLE `riwayat_satya_lencana`
  MODIFY `id_satya_lencana` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
